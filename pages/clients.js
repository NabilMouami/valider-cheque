...
export default function DataGridDemo() {
  ...
  const addActuelle = (item) => {
    axios.post("/api/actuallity/post", item).then((res) => {
      toast.success("Success: Vous avez ajouter Le Client en Actuellement.");
  ...
  const saveSortie = () => {
    axios.post("/api/sortie/post", datas).then(async (res) => {
     await toast.success("Success: Vous avez ajouter Le Client en Sortie.");
   await setOpen(false);
      ...
      renderCell: (params) => (
        <div>
          <span style={{ color: "red" }}>
            ...
            />
            <Button variant="outlined" color="success" onClick={() => addActuelle(params.row)}>Actuel</Button>

            <Button variant="outlined" color="error" onClick={() => addSortie(params.row)}>sortie</Button>
          </span>
        </div>
      ),
    },
      ...
      <div style={{ display: "flex", justifyContent: "space-around" }}>
        ...
        >
          <Box sx={style}>
            ...
            ></textarea>
            <Button variant="contained" onClick={() => saveSortie()}>Save</Button>
          </Box>
        </Modal>
